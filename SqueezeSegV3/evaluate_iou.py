...
from utils.laserscan import SemLaserScan
...
if __name__ == '__main__':
  ...
  for sequence in test_sequences:
    ...
    pred_paths = os.path.join(FLAGS.predictions, "sequences",
                              str(sequence), "predictions")
    # print(pred_paths)
    # populate the label names
    seq_pred_names = [os.path.join(pred_paths, f) for f in os.listdir(pred_paths + '/')]
    seq_pred_names.sort()
